...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(150, 10, 100, 20))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.setText("打开历史记录")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "希铭验光仪测试记录"))
